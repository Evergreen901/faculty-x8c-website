    ...
    return (
        <div className="w-screen min-h-screen">
            <div className="w-full px-6">
                <div className="max-w-[1220px] mx-auto w-full py-[10vh] md:py-[200px] content-wrapper detail">
                    <a href="/" className="flex items-center text-md md:text-lg">
                        <ArrowRightIcon className="w-6 h-6 rotate-[180deg] mr-2" />
                        Back to Home
                    </a>
                    <h2>Privacy Policy for AQUITY INC.</h2>
                    <p>
                        At Faculty Group, accessible from https://faculty.group, one of our main priorities is the
                        privacy of our visitors. This Privacy Policy document contains types of information that is
                        collected and recorded by Faculty Group and how we use it.
                    </p>
                    ...
                    <p>
                        ...
                        website with regards to the information that they shared and/or collect in Faculty Group. This
                    ...
                    <p>
                        Faculty Group follows a standard procedure of using log files. These files log visitors when
                    ...
                    <p>
                        Like any other website, Faculty Group uses 'cookies'. These cookies are used to store
                    ...
                    <p>
                        ...
                        that are used in their respective advertisements and links that appear on Faculty Group, which
                    ...
                    <p>
                        Note that Faculty Group has no access to or control over these cookies that are used by
                    ...
                    <p>
                        Faculty Group's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <p>
                        Faculty Group does not knowingly collect any Personal Identifiable Information from children
